...
namespace ShoppingAppMVC.Controllers
{
    ...
    public class ItemsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Item>> PostItem(Item item)
        {
          if (_context.Items == null)
          {
              return Problem("Entity set 'shoppingDBContext.Items'  is null.");
          }
            ...
            return CreatedAtAction("GetItem", new { id = item.ItemName }, item);
        }
        ...
        {
            return (_context.Items?.Any(e => e.ItemName == id)).GetValueOrDefault();
        }
        */
    }
}
