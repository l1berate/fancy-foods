    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Orders != null ? 
                          ...
                          Problem("Entity set 'shoppingDBContext.Orders'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderNumber,ItemsList,FullName,EmailAddress,Address,CardNumber,ExpDate,CvvNumber")] Order order)
        {
        ...
        {
          return (_context.Orders?.Any(e => e.OrderNumber == id)).GetValueOrDefault();
        }
    }
}
